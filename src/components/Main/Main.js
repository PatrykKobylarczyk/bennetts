    ...
    return (
        ...
        <div className="w-full lg:px-16">
            ...
            <section className='my-10 px-5 lg:mt-28 lg:px-0'>
                <h3 className='text-sm opacity-70 mb-5 lg:text-lg'>Categories</h3>
            ...
            {/* CAROUSEL SECTION */}
            <section className="carouselSection w-auto flex flex-col mx-3 lg:mx-0 lg:mt-28">
                <h3 className='mb-5 lg:mb-9 text-sm lg:text-lg opacity-70 mx-2 lg:mx-0'>Most popular</h3>
                <Carousel />
            </section>
